...
public class MsgConstant4g {
    ...
    public static final String DEVICE_START_FINISH_MSG = "03";
    public static final String DEVICE_START_MSG = "03";

    public static final String DEVICE_TASK_FINISH_MSG = "05";
    public static final String DEVICE_TASK_FINISH_RESPONSE_MSG = "05";
    ...
    public static final int DEVICE_NAME_FIELD_SIZE = 25;
